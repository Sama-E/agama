...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, pId, handleClick }) => {
  ...
  return (
    <div className="sm:w-[288px] w-full  bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          ...
          {/* Amounted Collected & Target Amount */}
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          ...
          {/* Profile Image & Owner */}
          <div className="w-[30px] h-[30px] flex justify-center items-center bg-[#13131a]">
